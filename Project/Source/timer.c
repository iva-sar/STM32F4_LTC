...
uint32_t APB1_CLK; // APB1 clock - max. 42 MHz!
	...
	APB1_CLK = RCC_Clocks.PCLK1_Frequency; // WARNING: APB1 is "slow" peripheral interface that with // SYSCLK = 168 MHz cannot be faster than 42 MHz (APB1 domain!) (pp. 213)
